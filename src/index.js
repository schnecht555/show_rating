...
function component() {
  ...
  mng.loadDownWardsCarousel().then(function(arrayNewsCarousel) {
    ...
    document.addEventListener("keydown", function(event) {
      if (event.key === "0") {
        ...
        const selectedDescription = arrayNewsCarousel[currentArticleIndex].description;
        const popupContent = `Title: ${selectedTitle}\nDescription: ${selectedDescription}`;
